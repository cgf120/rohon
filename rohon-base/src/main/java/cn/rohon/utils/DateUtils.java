...
import cn.rohon.base.StringPool;
...
public class DateUtils {
    ...
    public static final DateTimeFormatter DATETIME_MINI_FORMATTER = DateTimeFormatter.ofPattern(DateUtils.PATTERN_DATETIME_MINI);
    ...
    public static Date parse(String dateStr, String pattern) {
        ...
        try {
            ...
            throw new MyException(MyExceptionEnum.ParseException);
        }
    }
